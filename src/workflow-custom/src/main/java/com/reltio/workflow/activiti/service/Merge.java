...
/**
 * Merge entities from Reltio Cloud
 */
public class Merge implements WorkflowAction {
    ...
    public void execute(Execution execution) throws Exception {
        ...
        //Reltio Call
        String url = Utility.generateTenantUrl(environmentUrl, tenantId) + "/" + entityURI1 + "/_sameAs?uri=" + entityURI2;
